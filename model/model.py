...
class BiDAF(nn.Module):
    def __init__(self, args, pretrained):
        ...
        self.self_attention = MultiHeadAttention(in_features= args.hidden_size * 2, head_num = 1)
    ...
    def forward(self, batch):
        ...
        # Our layer: intra-sentence attention layer
        c = self.self_attention(c, c, c)
        q = self.self_attention(q, q, q)
        # 4. Attention Flow Layer
